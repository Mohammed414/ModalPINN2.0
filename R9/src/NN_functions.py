...
def out_nn_modes_uv(x,y,weights,biases,geom,freestream_target=None,damp_fluctuations=False,kill_k0_imag=False,hard_sym=False,is_v=False,street_params=None,trust_rho=0.6,trust_cap=0.12):
    '''
...
def NN_time_uv(x,y,t,weights,biases,geom,omega_0,trunc_mode=None,freestream_target=None,damp_fluctuations=False,kill_k0_imag=False,hard_sym=False,is_v=False,street_params=None,trust_rho=0.6,trust_cap=0.12):
    '''
    ...
    '''
    out_NN = out_nn_modes_uv(x,y,weights,biases,geom,freestream_target=freestream_target,damp_fluctuations=damp_fluctuations,kill_k0_imag=kill_k0_imag,hard_sym=hard_sym,is_v=is_v,street_params=street_params,trust_rho=trust_rho,trust_cap=trust_cap)
    Nmode = int(out_NN[0,0,:].shape[0])
