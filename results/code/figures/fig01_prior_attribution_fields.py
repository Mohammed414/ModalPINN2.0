...
SNAP = np.load(ROOT / "data" / "geometry" / "a04_snapshot_fields.npz")
PRIOR = np.load(
    ROOT / "data" / "geometry" / "street_prior_used.npz"
)
...
out = save_figure(fig, ROOT / "figures" / "F01_prior_attribution_fields")
print(out)
