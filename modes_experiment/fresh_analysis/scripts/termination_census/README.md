...
| `08_figure_arm1_rerun_breakdown.py` | Renders `F_arm1_rerun_breakdown.png`. Requires `figure_common.py` from `modes_experiment/fresh_analysis/` on the path. |
...
`modes_experiment/fresh_analysis/` directory — not included here, as it is
