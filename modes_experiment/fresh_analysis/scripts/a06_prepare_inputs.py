...
def main() -> None:
    ...
    if not audit["matched_within_20pct"]:
        print("The noisy arms trained LESS than the clean reference, so a 'noise hurts'")
        print("result from this group would be confounded. A 'noise does not hurt'")
        print("result is safe as a lower bound. Check the direction before writing.")
