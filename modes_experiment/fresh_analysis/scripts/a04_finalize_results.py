...
def main() -> None:
    ...
    prior_path = REPO / "modes_experiment" / "runs" / "arms" / "15_karman_prior_fluct_off" / "street_prior_used.npz"
    ...
    changes_source = "modes_experiment/fresh_analysis/derived/a04_prior_attribution_changes.csv"
    for row in changes:
