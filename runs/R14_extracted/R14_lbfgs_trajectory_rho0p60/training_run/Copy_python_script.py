...
if _r14_ckpt_targets:
    ...
    print('R14 saved accepted-step checkpoint iter=0')
    ...
    def _r14_accepted_step_callback(xk):
        ...
        if ii in _r14_ckpt_targets:
            ...
            print('R14 CHECKPOINT accepted_iter=%d saved'%ii)
            sys.stdout.flush()
else:
...
if _r14_ckpt_targets:
    ...
    print('R14 accepted L-BFGS iterations:',_r14_final_iter)
    ...
    if _r14_state['last_xk'] is not None:
        ...
        print('R14 final session-flat vs last accepted xk relative difference = %.3e'%_rel)
        if _rel > 5.e-5:
            raise RuntimeError('R14 accepted-step packed-vector mapping check failed.')
    ...
    if not os.path.exists(_final_flat_path):
        ...
        print('R14 saved additional final checkpoint iter=%d'%_r14_final_iter)
    ...
    for _ii,_ff in _items:
        ...
        print('R14 converted checkpoint iter=%d total=%.6e physics=%.6e taps=%.6e'%
              (_ii,_tot,_phy,_tap))
    ...
    print('R14 checkpoint manifest saved:',
