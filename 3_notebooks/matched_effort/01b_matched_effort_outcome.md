...
`6_analysis/decisions.md` (2026-08-28); mechanism and attempt log in
`6_analysis/findings.md` under "Training effort — the L-BFGS termination
...
`4_runs/*/train_log.txt` for 16 arms plus this re-run — so the census is
