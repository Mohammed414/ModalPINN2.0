...
def main() -> None:
    ...
    prior_copy = REPO_ROOT / "5_baselines" / "prior_only_evaluation" / "street_prior_used.npz"
    ...
    data = REPO_ROOT / "1_data" / "fixed_cylinder_atRe100"
    cache = REPO_ROOT / "1_data" / "flow_cache.npz"
    ...
    manifest = {
        ...
        "evaluation_contract": "6_analysis/data_contract.md",
        "artifacts": [
