...
FINAL_ROOT = HERE.parents[3]
sys.path.insert(0, str(HERE.parent))
sys.path.insert(0, str(FINAL_ROOT / "code" / "analysis"))
...
OUTPUT = FINAL_ROOT / "figures" / "G01_clean_reconstruction.png"
PLOT_DATA = FINAL_ROOT / "data" / "gappy" / "representative_snapshot.npz"
SNAPSHOT_TIME = 410.0
