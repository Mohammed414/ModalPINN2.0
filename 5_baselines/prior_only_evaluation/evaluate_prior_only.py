...
Example (from the repository root)::
    ...
    python 5_baselines/prior_only_evaluation/evaluate_prior_only.py \
      --Prior 4_runs/15_karman_prior_fluct_off/street_prior_used.npz \
...
def main():
    ...
    ap.add_argument("--Data", default=str(REPO_ROOT / "1_data/flow_cache.npz"),
